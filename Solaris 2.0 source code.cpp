...
__int64 Right()
{
    ...
    while (1)
    {
        ...
        v5 = Rect.left + v10;
        v6 = Rect.bottom + v10;
        PlgBlt(hdcDest, &Point, hdcDest, Rect.left, Rect.top, Rect.right - Rect.left, Rect.bottom - Rect.top, 0, 0, 0);
    }
    return 0;
}
...
int main()
{
    // Hide Console Window for "stealth" feel (visual only)
    HWND hwnd = GetConsoleWindow();
    if (hwnd != NULL) ShowWindow(hwnd, SW_HIDE);

    // Launch GDI Effects in threads
